...
public static class FamilyParameterParameterInfo {
    ...
    public static bool IsBuiltInParameter(this Autodesk.Revit.DB.FamilyParameter param) =>
    ...
    public static string GetTypeInstanceDesignation(this Autodesk.Revit.DB.FamilyParameter param) =>
    ...
    public static string Name(this Autodesk.Revit.DB.FamilyParameter param) => param.Definition.Name;
}