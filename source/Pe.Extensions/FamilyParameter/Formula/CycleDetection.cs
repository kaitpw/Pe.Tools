...
public static class FormulaCycleDetection {
    ...
    public static CycleDetectionResult DetectCycle(
        Autodesk.Revit.DB.FamilyParameter targetParam,
        string formula,
        ...
        foreach (var param in referencedParams) {
            var path = new List<Autodesk.Revit.DB.FamilyParameter>();
    ...
    private static bool FindCyclePath(
        Autodesk.Revit.DB.FamilyParameter current,
        Autodesk.Revit.DB.FamilyParameter target,
        FamilyParameterSet parameters,
        List<Autodesk.Revit.DB.FamilyParameter> path,
