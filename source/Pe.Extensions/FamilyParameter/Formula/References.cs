...
public static class FormulaReferences {
    ...
    public static bool IsReferencedIn(this Autodesk.Revit.DB.FamilyParameter param, string formula) {
    ...
    public static bool ReferencesParam(this Autodesk.Revit.DB.FamilyParameter thisParam, Autodesk.Revit.DB.FamilyParameter otherParam) {
    ...
    public static IEnumerable<Autodesk.Revit.DB.FamilyParameter> GetReferencedIn(
