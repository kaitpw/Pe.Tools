...
public static class FormulaAnalysis {
    ...
    public static Autodesk.Revit.DB.FamilyParameter TryGetSingleReference(this FamilyParameterSet parameters, string formula) {
    ...
    public static FormulaChainResult ResolveChain(this Autodesk.Revit.DB.FamilyParameter param, FamilyParameterSet parameters) {
        var intermediates = new List<Autodesk.Revit.DB.FamilyParameter>();
        var current = param;
