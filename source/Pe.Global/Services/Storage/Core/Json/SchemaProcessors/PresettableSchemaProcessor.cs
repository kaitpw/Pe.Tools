...
/// <summary>
///     Schema processor that adds optional $preset support to object properties
///     marked with [Presettable(...)].
/// </summary>
public sealed class PresettableSchemaProcessor : ISchemaProcessor {
    public void Process(SchemaProcessorContext context) {
        ...
        foreach (var property in context.ContextualType.Type.GetProperties()) {
            ...
            if (presettableAttr == null) continue;
            if (!IsComplexObjectType(property.PropertyType)) continue;
    ...
    private static JsonSchema CreatePresetDirectiveObjectSchema(string fragmentSchemaName) {
        ...
        presetProperty.ExtensionData["examples"] = new List<string> {
                ...
                $"@global/{normalizedRoot}/my-preset"
        };
